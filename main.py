...
def main():
    (address, info, exchange, vault, allora_upshot_key, hyperbolic_api_key, check_for_trades, price_gap,
    ...
    print(res)
    allora_mind = AlloraMind(manager, allora_upshot_key, hyperbolic_api_key, threshold=price_gap)
